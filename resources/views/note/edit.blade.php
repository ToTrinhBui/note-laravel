<x-app-layout>
    <div class="note-container single-note m-auto w-4/5 p-8">
        <h1 class="text-xl text-gray-400">Fix your memories here</h1>
        <form
        ...
        >
            ...
            <div class="note-content bg-white">
                <textarea
                    ...
                    rows="15"
                    required
                    class="note-body block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                >
                {!! $note->note !!}
            </textarea
                >
